...
const getDealsHtml = (products, settings) => {
  const {
    affiliateTag, product1, product2, product3,
    titleLine1 = '',
    titleLine2 = '',
    titleFontSize = '18px',
    titleFontColor = '#6366f1',
  ...
  const filteredProducts = [product1, product2, product3].some(Boolean)
      ? products.filter((p) => [product1, product2, product3].includes(p.productId))
      : products.slice(0, 20);
